...
namespace geode::modifier {
	...
	#ifndef GEODE_STATICS_getScreenBottom
		#define GEODE_STATICS_getScreenBottom
		GEODE_AS_STATIC_FUNCTION(getScreenBottom) 
	#endif

	#ifndef GEODE_STATICS_getScreenLeft
		#define GEODE_STATICS_getScreenLeft
		GEODE_AS_STATIC_FUNCTION(getScreenLeft) 
	#endif

	#ifndef GEODE_STATICS_getScreenRight
		#define GEODE_STATICS_getScreenRight
		GEODE_AS_STATIC_FUNCTION(getScreenRight) 
	#endif
	...
	#ifndef GEODE_STATICS_getScreenTop
		#define GEODE_STATICS_getScreenTop
		GEODE_AS_STATIC_FUNCTION(getScreenTop) 
	#endif
	...
	#ifndef GEODE_STATICS_setSceneDelegate
		#define GEODE_STATICS_setSceneDelegate
		GEODE_AS_STATIC_FUNCTION(setSceneDelegate) 
	#endif

	#ifndef GEODE_STATICS_getSceneDelegate
		#define GEODE_STATICS_getSceneDelegate
		GEODE_AS_STATIC_FUNCTION(getSceneDelegate) 
	#endif
	...
	struct ModifyDerive<Der, cocos2d::CCDirector> : ModifyBase<ModifyDerive<Der, cocos2d::CCDirector>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::sharedDirector)), Cdecl, cocos2d::CCDirector, sharedDirector, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenBottom)), Thiscall, cocos2d::CCDirector, getScreenBottom, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenLeft)), Thiscall, cocos2d::CCDirector, getScreenLeft, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenRight)), Thiscall, cocos2d::CCDirector, getScreenRight, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCDirector::getScreenTop)), Thiscall, cocos2d::CCDirector, getScreenTop, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<cocos2d::CCSceneDelegate*>::func(&cocos2d::CCDirector::setSceneDelegate)), Thiscall, cocos2d::CCDirector, setSceneDelegate, cocos2d::CCSceneDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCDirector::getSceneDelegate)), Thiscall, cocos2d::CCDirector, getSceneDelegate, )
		}
	};
}

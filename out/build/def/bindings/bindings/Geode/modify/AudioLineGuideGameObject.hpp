...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AudioLineGuideGameObject> : ModifyBase<ModifyDerive<Der, AudioLineGuideGameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b6730, Optcall, AudioLineGuideGameObject, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3b67d0, Thiscall, AudioLineGuideGameObject, init, )
		}
	};
}

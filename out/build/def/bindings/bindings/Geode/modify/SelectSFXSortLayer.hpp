...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectSFXSortLayer> : ModifyBase<ModifyDerive<Der, SelectSFXSortLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37a410, Optcall, SelectSFXSortLayer, create, AudioSortType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37a4b0, Membercall, SelectSFXSortLayer, init, AudioSortType)
		}
	};
}

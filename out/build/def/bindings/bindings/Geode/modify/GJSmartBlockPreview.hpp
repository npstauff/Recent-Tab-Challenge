...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJSmartBlockPreview> : ModifyBase<ModifyDerive<Der, GJSmartBlockPreview>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x222fc0, Optcall, GJSmartBlockPreview, create, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x223080, Membercall, GJSmartBlockPreview, init, gd::string)
		}
	};
}

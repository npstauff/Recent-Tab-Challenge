...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountLayer> : ModifyBase<ModifyDerive<Der, AccountLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x583a0, Thiscall, AccountLayer, backupAccountFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58500, Thiscall, AccountLayer, backupAccountFailed, BackupAccountError, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58730, Thiscall, AccountLayer, syncAccountFinished, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58890, Thiscall, AccountLayer, syncAccountFailed, BackupAccountError, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58050, Thiscall, AccountLayer, accountStatusChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58940, Thiscall, AccountLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}

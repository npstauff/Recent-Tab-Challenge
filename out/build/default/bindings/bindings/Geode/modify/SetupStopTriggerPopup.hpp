...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupStopTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupStopTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36d6a0, Thiscall, SetupStopTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36d600, Thiscall, SetupStopTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}

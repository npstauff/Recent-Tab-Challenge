...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TableViewCellDelegate> : ModifyBase<ModifyDerive<Der, TableViewCellDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x224d20, Thiscall, TableViewCellDelegate, cellPerformedAction, TableViewCell*, int, CellAction, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1d800, Thiscall, TableViewCellDelegate, shouldSnapToSelected, )
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountLoginLayer> : ModifyBase<ModifyDerive<Der, AccountLoginLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x55bf0, Optcall, AccountLoginLayer, create, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x55cb0, Membercall, AccountLoginLayer, init, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56440, Membercall, AccountLoginLayer, onForgotPassword, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56420, Membercall, AccountLoginLayer, onForgotUser, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56e10, Thiscall, AccountLoginLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56ab0, Thiscall, AccountLoginLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56f40, Thiscall, AccountLoginLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56680, Thiscall, AccountLoginLayer, loginAccountFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x56840, Thiscall, AccountLoginLayer, loginAccountFailed, AccountError)
		}
	};
}

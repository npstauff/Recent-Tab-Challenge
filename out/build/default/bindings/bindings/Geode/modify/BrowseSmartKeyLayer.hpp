...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BrowseSmartKeyLayer> : ModifyBase<ModifyDerive<Der, BrowseSmartKeyLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35c240, Optcall, BrowseSmartKeyLayer, create, GJSmartTemplate*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35c310, Membercall, BrowseSmartKeyLayer, init, GJSmartTemplate*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35cfe0, Thiscall, BrowseSmartKeyLayer, onBack, cocos2d::CCObject*)
		}
	};
}

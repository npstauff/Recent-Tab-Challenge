...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupAreaAnimTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupAreaAnimTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3239c0, Thiscall, SetupAreaAnimTriggerPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x323b90, Thiscall, SetupAreaAnimTriggerPopup, valueDidChange, int, float)
		}
	};
}

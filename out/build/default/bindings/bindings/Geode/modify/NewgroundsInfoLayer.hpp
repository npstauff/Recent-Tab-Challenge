...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, NewgroundsInfoLayer> : ModifyBase<ModifyDerive<Der, NewgroundsInfoLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x90e90, Optcall, NewgroundsInfoLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x90f30, Thiscall, NewgroundsInfoLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x918e0, Thiscall, NewgroundsInfoLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}

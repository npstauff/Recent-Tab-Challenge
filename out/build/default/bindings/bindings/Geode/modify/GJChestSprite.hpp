...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJChestSprite> : ModifyBase<ModifyDerive<Der, GJChestSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa540, Thiscall, GJChestSprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa480, Thiscall, GJChestSprite, setColor, cocos2d::ccColor3B const&)
		}
	};
}

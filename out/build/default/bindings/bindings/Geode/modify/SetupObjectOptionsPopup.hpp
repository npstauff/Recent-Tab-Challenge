...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectOptionsPopup> : ModifyBase<ModifyDerive<Der, SetupObjectOptionsPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314f00, Optcall, SetupObjectOptionsPopup, create, GameObject*, cocos2d::CCArray*, SetGroupIDLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x314fb0, Membercall, SetupObjectOptionsPopup, init, GameObject*, cocos2d::CCArray*, SetGroupIDLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x316170, Thiscall, SetupObjectOptionsPopup, determineStartValues, )
		}
	};
}

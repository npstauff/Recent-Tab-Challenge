...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupObjectOptions2Popup> : ModifyBase<ModifyDerive<Der, SetupObjectOptions2Popup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x316fe0, Optcall, SetupObjectOptions2Popup, create, GameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x317090, Membercall, SetupObjectOptions2Popup, init, GameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3173b0, Thiscall, SetupObjectOptions2Popup, onPlusButton, cocos2d::CCObject*)
		}
	};
}

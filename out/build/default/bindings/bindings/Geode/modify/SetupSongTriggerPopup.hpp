...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupSongTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupSongTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35d280, Optcall, SetupSongTriggerPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35d330, Membercall, SetupSongTriggerPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35dfe0, Thiscall, SetupSongTriggerPopup, pageChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35e050, Thiscall, SetupSongTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35df10, Thiscall, SetupSongTriggerPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35dbf0, Thiscall, SetupSongTriggerPopup, onPlayback, SongInfoObject*)
		}
	};
}

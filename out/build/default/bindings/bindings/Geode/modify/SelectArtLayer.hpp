...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectArtLayer> : ModifyBase<ModifyDerive<Der, SelectArtLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26fcb0, Optcall, SelectArtLayer, create, SelectArtType, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26fd60, Membercall, SelectArtLayer, init, SelectArtType, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x270b20, Thiscall, SelectArtLayer, keyBackClicked, )
		}
	};
}

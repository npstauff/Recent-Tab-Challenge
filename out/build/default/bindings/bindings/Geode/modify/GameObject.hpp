...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameObject> : ModifyBase<ModifyDerive<Der, GameObject>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x142a50, Membercall, GameObject, colorForMode, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1310c0, Membercall, GameObject, commonSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d8f0, Membercall, GameObject, copyGroups, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b790, Membercall, GameObject, createAndAddParticle, int, char const*, int, cocos2d::tCCPositionType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d790, Membercall, GameObject, createGroupContainer, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x130fc0, Optcall, GameObject, createWithFrame, char const*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x130330, Optcall, GameObject, createWithKey, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d3c0, Membercall, GameObject, determineSlopeDirection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1424c0, Membercall, GameObject, duplicateColorMode, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1426f0, Membercall, GameObject, duplicateValues, GameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x142d30, Membercall, GameObject, getActiveColorForMode, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x132f00, Membercall, GameObject, getColorFrame, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13df90, Membercall, GameObject, getColorKey, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d620, Membercall, GameObject, getObjectDirection, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13ca30, Membercall, GameObject, getParentMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x142320, Membercall, GameObject, getRelativeSpriteColor, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13dd70, Membercall, GameObject, groupOpacityMod, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x143d60, Membercall, GameObject, ignoreEditorDuration, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1431d0, Membercall, GameObject, isEditorSpawnableTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x142180, Membercall, GameObject, isFacingDown, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x142220, Membercall, GameObject, isFacingLeft, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1434e0, Membercall, GameObject, isSpawnableTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x143970, Membercall, GameObject, isSpeedObject, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x143800, Membercall, GameObject, isStoppableTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x142ea0, Membercall, GameObject, isTrigger, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13dc20, Membercall, GameObject, loadGroupsFromString, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13e420, Optcall, GameObject, objectFromVector, gd::vector<gd::string>&, gd::vector<void*>&, GJBaseGameLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x14a660, Membercall, GameObject, playDestroyObjectAnim, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13bf40, Membercall, GameObject, playShineEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x133880, Membercall, GameObject, shouldBlendColor, GJSpriteColor*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x139d10, Membercall, GameObject, shouldLockX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13cf30, Membercall, GameObject, updateBlendMode, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b290, Membercall, GameObject, updateCustomScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b350, Membercall, GameObject, updateCustomScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x141fe0, Membercall, GameObject, updateIsOriented, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x141b70, Membercall, GameObject, updateObjectEditorColor, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x133160, Membercall, GameObject, updateStartPos, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13af80, Thiscall, GameObject, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b010, Thiscall, GameObject, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b0a0, Thiscall, GameObject, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13aa40, Thiscall, GameObject, setPosition, cocos2d::CCPoint const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b890, Thiscall, GameObject, setVisible, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13ac30, Thiscall, GameObject, setRotation, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13ad30, Thiscall, GameObject, setRotationX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13ae30, Thiscall, GameObject, setRotationY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13b490, Thiscall, GameObject, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x131080, Thiscall, GameObject, initWithTexture, cocos2d::CCTexture2D*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x141630, Thiscall, GameObject, setChildColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13af00, Thiscall, GameObject, setFlipX, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13af40, Thiscall, GameObject, setFlipY, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x133940, Thiscall, GameObject, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x14dda0, Thiscall, GameObject, setupCustomSprites, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13cf90, Thiscall, GameObject, addMainSpriteToParent, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x133790, Thiscall, GameObject, deactivateObject, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13a500, Thiscall, GameObject, transferObjectRect, cocos2d::CCRect&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13a570, Thiscall, GameObject, getObjectRect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13a570, Thiscall, GameObject, getObjectRect, float, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13f9a0, Thiscall, GameObject, getSaveString, GJBaseGameLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13aee0, Thiscall, GameObject, isFlipX, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13aef0, Thiscall, GameObject, isFlipY, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x141300, Thiscall, GameObject, setObjectColor, cocos2d::ccColor3B const&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x141690, Thiscall, GameObject, selectObject, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d7f0, Thiscall, GameObject, addToGroup, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x13d870, Thiscall, GameObject, removeFromGroup, int)
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJFollowCommandLayer> : ModifyBase<ModifyDerive<Der, GJFollowCommandLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1edcb0, Thiscall, GJFollowCommandLayer, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eeb60, Thiscall, GJFollowCommandLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ee4a0, Thiscall, GJFollowCommandLayer, textChanged, CCTextInputNode*)
		}
	};
}

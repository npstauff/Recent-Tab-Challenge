...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AppDelegate> : ModifyBase<ModifyDerive<Der, AppDelegate>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5b0b0, Membercall, AppDelegate, platformShutdown, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5b6c0, Membercall, AppDelegate, resumeSound, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5b0c0, Membercall, AppDelegate, setupGLView, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5b4e0, Thiscall, AppDelegate, applicationWillResignActive, )

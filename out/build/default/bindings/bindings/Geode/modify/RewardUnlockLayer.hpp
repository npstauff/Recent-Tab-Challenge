...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RewardUnlockLayer> : ModifyBase<ModifyDerive<Der, RewardUnlockLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f7af0, Optcall, RewardUnlockLayer, create, int, RewardsPage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f7ba0, Membercall, RewardUnlockLayer, init, int, RewardsPage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f8860, Membercall, RewardUnlockLayer, showCollectReward, GJRewardItem*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2fa330, Thiscall, RewardUnlockLayer, currencyWillExit, CurrencyRewardLayer*)
		}
	};
}

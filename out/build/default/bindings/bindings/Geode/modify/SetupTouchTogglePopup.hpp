...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTouchTogglePopup> : ModifyBase<ModifyDerive<Der, SetupTouchTogglePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x362f10, Thiscall, SetupTouchTogglePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3634c0, Thiscall, SetupTouchTogglePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x363430, Thiscall, SetupTouchTogglePopup, textChanged, CCTextInputNode*)
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SongOptionsLayer> : ModifyBase<ModifyDerive<Der, SongOptionsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x90140, Optcall, SongOptionsLayer, create, CustomSongDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x901e0, Membercall, SongOptionsLayer, init, CustomSongDelegate*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x90e80, Thiscall, SongOptionsLayer, keyBackClicked, )
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SelectEventLayer> : ModifyBase<ModifyDerive<Der, SelectEventLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x364ec0, Optcall, SelectEventLayer, create, SetupEventLinkPopup*, gd::set<int>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x364f70, Membercall, SelectEventLayer, init, SetupEventLinkPopup*, gd::set<int>&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x365990, Thiscall, SelectEventLayer, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x365820, Thiscall, SelectEventLayer, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}

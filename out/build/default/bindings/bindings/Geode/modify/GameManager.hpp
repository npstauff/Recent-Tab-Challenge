...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GameManager> : ModifyBase<ModifyDerive<Der, GameManager>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x127270, Optcall, GameManager, countForType, IconType)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x12e390, Membercall, GameManager, safePopScene, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x12de70, Thiscall, GameManager, update, float)

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer> : ModifyBase<ModifyDerive<Der, SecretLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3017d0, Thiscall, SecretLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3052b0, Thiscall, SecretLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x303560, Thiscall, SecretLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x303690, Thiscall, SecretLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x303730, Thiscall, SecretLayer, textChanged, CCTextInputNode*)
		}
	};
}

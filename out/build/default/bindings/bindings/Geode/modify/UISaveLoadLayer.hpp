...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UISaveLoadLayer> : ModifyBase<ModifyDerive<Der, UISaveLoadLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x215e10, Optcall, UISaveLoadLayer, create, UIOptionsLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x215eb0, Membercall, UISaveLoadLayer, init, UIOptionsLayer*)
		}
	};
}

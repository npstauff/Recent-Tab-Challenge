...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupKeyframePopup> : ModifyBase<ModifyDerive<Der, SetupKeyframePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x333c10, Thiscall, SetupKeyframePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x333660, Thiscall, SetupKeyframePopup, onCustomButton, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x333590, Thiscall, SetupKeyframePopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3335c0, Thiscall, SetupKeyframePopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}

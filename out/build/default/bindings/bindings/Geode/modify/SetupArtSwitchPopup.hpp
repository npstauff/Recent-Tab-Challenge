...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupArtSwitchPopup> : ModifyBase<ModifyDerive<Der, SetupArtSwitchPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36caa0, Optcall, SetupArtSwitchPopup, create, ArtTriggerGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36cbf0, Membercall, SetupArtSwitchPopup, init, ArtTriggerGameObject*, cocos2d::CCArray*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36cff0, Thiscall, SetupArtSwitchPopup, selectArtClosed, SelectArtLayer*)
		}
	};
}

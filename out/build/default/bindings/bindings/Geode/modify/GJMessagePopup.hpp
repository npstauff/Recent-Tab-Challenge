...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMessagePopup> : ModifyBase<ModifyDerive<Der, GJMessagePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20c7d0, Optcall, GJMessagePopup, create, GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20c870, Membercall, GJMessagePopup, init, GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20db20, Thiscall, GJMessagePopup, downloadMessageFinished, GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20db70, Thiscall, GJMessagePopup, downloadMessageFailed, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20dbb0, Thiscall, GJMessagePopup, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20dcb0, Thiscall, GJMessagePopup, uploadActionFailed, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20dd00, Thiscall, GJMessagePopup, onClosePopup, UploadActionPopup*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x20dd70, Thiscall, GJMessagePopup, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, LoadingCircle> : ModifyBase<ModifyDerive<Der, LoadingCircle>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x486f0, Thiscall, LoadingCircle, draw, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x48700, Thiscall, LoadingCircle, registerWithTouchDispatcher, )
		}
	};
}

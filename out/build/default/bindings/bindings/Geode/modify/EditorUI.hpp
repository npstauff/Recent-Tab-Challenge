...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorUI> : ModifyBase<ModifyDerive<Der, EditorUI>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xd0430, Membercall, EditorUI, createLoop, )
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xaa080, Optcall, EditorUI, shouldDeleteObject, GameObject*)

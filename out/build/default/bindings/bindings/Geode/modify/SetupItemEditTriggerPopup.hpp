...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupItemEditTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupItemEditTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x369a30, Thiscall, SetupItemEditTriggerPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3697f0, Thiscall, SetupItemEditTriggerPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}

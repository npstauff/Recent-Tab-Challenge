...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShaderLayer> : ModifyBase<ModifyDerive<Der, ShaderLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37b720, Optcall, ShaderLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3836c0, Membercall, ShaderLayer, performCalculations, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x383fe0, Membercall, ShaderLayer, resetAllShaders, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37f9b0, Membercall, ShaderLayer, triggerChromaticGlitch, bool, float, float, float, float, float, float, float, int, float, bool, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37f130, Membercall, ShaderLayer, triggerGlitch, float, float, float, float, float, float, float, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37e540, Membercall, ShaderLayer, triggerShockLine, float, float, bool, bool, bool, bool, float, float, float, float, float, float, int, bool, bool, bool, float, bool, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37d810, Membercall, ShaderLayer, triggerShockWave, float, float, float, float, float, float, float, bool, float, float, float, int, bool, bool, bool, float, float, bool, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x383a20, Membercall, ShaderLayer, tweenValueAuto, float, int, float, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x383f60, Membercall, ShaderLayer, updateZLayer, int, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37bde0, Thiscall, ShaderLayer, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x37b7c0, Thiscall, ShaderLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x383810, Thiscall, ShaderLayer, visit, )
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJMessageCell> : ModifyBase<ModifyDerive<Der, GJMessageCell>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8a3a0, Membercall, GJMessageCell, loadFromMessage, GJUserMessage*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x896b0, Thiscall, GJMessageCell, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8ad70, Thiscall, GJMessageCell, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8ae30, Thiscall, GJMessageCell, uploadActionFinished, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x8af10, Thiscall, GJMessageCell, uploadActionFailed, int, int)
		}
	};
}

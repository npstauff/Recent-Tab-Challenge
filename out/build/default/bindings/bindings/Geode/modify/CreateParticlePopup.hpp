...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CreateParticlePopup> : ModifyBase<ModifyDerive<Der, CreateParticlePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3380b0, Optcall, CreateParticlePopup, create, ParticleGameObject*, cocos2d::CCArray*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x338190, Membercall, CreateParticlePopup, init, ParticleGameObject*, cocos2d::CCArray*, gd::string)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33f5b0, Membercall, CreateParticlePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33f540, Membercall, CreateParticlePopup, willClose, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33cbb0, Thiscall, CreateParticlePopup, update, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33f6d0, Thiscall, CreateParticlePopup, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33f7b0, Thiscall, CreateParticlePopup, ccTouchMoved, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33fbd0, Thiscall, CreateParticlePopup, ccTouchEnded, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33f6c0, Thiscall, CreateParticlePopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33ef20, Thiscall, CreateParticlePopup, sliderBegan, Slider*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33efc0, Thiscall, CreateParticlePopup, sliderEnded, Slider*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33c570, Thiscall, CreateParticlePopup, colorSelectClosed, cocos2d::CCNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x33cd20, Thiscall, CreateParticlePopup, textChanged, CCTextInputNode*)
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetFolderPopup> : ModifyBase<ModifyDerive<Der, SetFolderPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x210d90, Thiscall, SetFolderPopup, valueChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x210ff0, Thiscall, SetFolderPopup, setTextPopupClosed, SetTextPopup*, gd::string)
		}
	};
}

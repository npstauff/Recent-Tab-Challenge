...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupStaticCameraPopup> : ModifyBase<ModifyDerive<Der, SetupStaticCameraPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35f710, Optcall, SetupStaticCameraPopup, create, CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35f7c0, Membercall, SetupStaticCameraPopup, init, CameraTriggerGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35fd60, Thiscall, SetupStaticCameraPopup, valueDidChange, int, float)
		}
	};
}

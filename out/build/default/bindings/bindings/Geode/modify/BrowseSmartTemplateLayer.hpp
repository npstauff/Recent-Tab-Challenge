...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, BrowseSmartTemplateLayer> : ModifyBase<ModifyDerive<Der, BrowseSmartTemplateLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35c140, Thiscall, BrowseSmartTemplateLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x35c160, Thiscall, BrowseSmartTemplateLayer, onBack, cocos2d::CCObject*)
		}
	};
}

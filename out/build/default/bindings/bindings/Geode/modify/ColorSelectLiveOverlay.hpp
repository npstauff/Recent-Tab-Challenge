...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ColorSelectLiveOverlay> : ModifyBase<ModifyDerive<Der, ColorSelectLiveOverlay>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x61b20, Optcall, ColorSelectLiveOverlay, create, ColorAction*, ColorAction*, EffectGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x61bd0, Membercall, ColorSelectLiveOverlay, init, ColorAction*, ColorAction*, EffectGameObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x62fa0, Thiscall, ColorSelectLiveOverlay, keyBackClicked, )
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTriggerPopup> : ModifyBase<ModifyDerive<Der, SetupTriggerPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36e210, Membercall, SetupTriggerPopup, init, EffectGameObject*, cocos2d::CCArray*, float, float, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x377930, Thiscall, SetupTriggerPopup, ccTouchBegan, cocos2d::CCTouch*, cocos2d::CCEvent*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x365a00, Thiscall, SetupTriggerPopup, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x61860, Thiscall, SetupTriggerPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36ea50, Thiscall, SetupTriggerPopup, toggleGroup, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36f5d0, Thiscall, SetupTriggerPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x205870, Thiscall, SetupTriggerPopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36fa30, Thiscall, SetupTriggerPopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36fc20, Thiscall, SetupTriggerPopup, sliderBegan, Slider*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x36fcc0, Thiscall, SetupTriggerPopup, sliderEnded, Slider*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x371500, Thiscall, SetupTriggerPopup, updateDefaultTriggerValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3719c0, Thiscall, SetupTriggerPopup, updateInputNode, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x371bd0, Thiscall, SetupTriggerPopup, updateToggleItem, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x371c30, Thiscall, SetupTriggerPopup, getValue, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x376120, Thiscall, SetupTriggerPopup, triggerValueFromSliderValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x376190, Thiscall, SetupTriggerPopup, triggerSliderValueFromValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x376cb0, Thiscall, SetupTriggerPopup, valuePopupClosed, ConfigureValuePopup*, float)
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, UploadListPopup> : ModifyBase<ModifyDerive<Der, UploadListPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2600f0, Optcall, UploadListPopup, create, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x260190, Membercall, UploadListPopup, init, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x260a30, Thiscall, UploadListPopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x260630, Thiscall, UploadListPopup, listUploadFinished, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x260790, Thiscall, UploadListPopup, listUploadFailed, GJLevelList*, int)
		}
	};
}

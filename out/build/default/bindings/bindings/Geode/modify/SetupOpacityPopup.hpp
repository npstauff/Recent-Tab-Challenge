...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupOpacityPopup> : ModifyBase<ModifyDerive<Der, SetupOpacityPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x336840, Optcall, SetupOpacityPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3368f0, Membercall, SetupOpacityPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3374d0, Thiscall, SetupOpacityPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x337830, Thiscall, SetupOpacityPopup, textChanged, CCTextInputNode*)
		}
	};
}

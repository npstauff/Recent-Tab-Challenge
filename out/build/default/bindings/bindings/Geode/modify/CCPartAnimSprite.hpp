...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CCPartAnimSprite> : ModifyBase<ModifyDerive<Der, CCPartAnimSprite>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27160, Thiscall, CCPartAnimSprite, setScaleX, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27190, Thiscall, CCPartAnimSprite, setScaleY, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27130, Thiscall, CCPartAnimSprite, setScale, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x27310, Thiscall, CCPartAnimSprite, setOpacity, unsigned char)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x271c0, Thiscall, CCPartAnimSprite, setBlendFunc, cocos2d::_ccBlendFunc)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26e90, Thiscall, CCPartAnimSprite, setDisplayFrame, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26fa0, Thiscall, CCPartAnimSprite, isFrameDisplayed, cocos2d::CCSpriteFrame*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x26fc0, Thiscall, CCPartAnimSprite, displayFrame, )
		}
	};
}

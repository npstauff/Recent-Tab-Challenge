...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, ShareLevelSettingsLayer> : ModifyBase<ModifyDerive<Der, ShareLevelSettingsLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x389a70, Optcall, ShareLevelSettingsLayer, create, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x389b10, Membercall, ShareLevelSettingsLayer, init, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x38a600, Thiscall, ShareLevelSettingsLayer, keyBackClicked, )
		}
	};
}

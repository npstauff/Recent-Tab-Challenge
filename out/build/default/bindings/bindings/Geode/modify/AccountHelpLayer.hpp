...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, AccountHelpLayer> : ModifyBase<ModifyDerive<Der, AccountHelpLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58a10, Optcall, AccountHelpLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x58b90, Thiscall, AccountHelpLayer, customSetup, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x594f0, Thiscall, AccountHelpLayer, layerHidden, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x59220, Thiscall, AccountHelpLayer, accountStatusChanged, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x59480, Thiscall, AccountHelpLayer, FLAlert_Clicked, FLAlertLayer*, bool)
		}
	};
}

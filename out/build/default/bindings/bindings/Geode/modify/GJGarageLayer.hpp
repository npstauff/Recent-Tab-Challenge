...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGarageLayer> : ModifyBase<ModifyDerive<Der, GJGarageLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3420, Membercall, GJGarageLayer, descriptionForUnlock, int, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f2310, Membercall, GJGarageLayer, getItems, int, int, IconType, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1eedc0, Optcall, GJGarageLayer, node, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f1bf0, Membercall, GJGarageLayer, onArrow, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3c70, Membercall, GJGarageLayer, onBack, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f0c90, Membercall, GJGarageLayer, onInfo, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f1c80, Membercall, GJGarageLayer, onNavigate, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3bb0, Membercall, GJGarageLayer, onPaint, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f2d30, Membercall, GJGarageLayer, onSelect, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f1cb0, Membercall, GJGarageLayer, onSelectTab, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3b90, Membercall, GJGarageLayer, onShards, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3c00, Membercall, GJGarageLayer, onShop, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3110, Membercall, GJGarageLayer, onSpecial, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3050, Membercall, GJGarageLayer, onToggleItem, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3a00, Membercall, GJGarageLayer, playRainbowEffect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f1cd0, Membercall, GJGarageLayer, selectTab, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f1170, Membercall, GJGarageLayer, setupIconSelect, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f1d70, Membercall, GJGarageLayer, setupPage, int, IconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f2590, Membercall, GJGarageLayer, setupSpecialPage, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f32f0, Membercall, GJGarageLayer, titleForUnlock, int, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3180, Membercall, GJGarageLayer, updatePlayerColors, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ef250, Thiscall, GJGarageLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3de0, Thiscall, GJGarageLayer, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f0e40, Thiscall, GJGarageLayer, textInputOpened, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f0f90, Thiscall, GJGarageLayer, textInputClosed, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f32a0, Thiscall, GJGarageLayer, listButtonBarSwitchedPage, ListButtonBar*, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f32b0, Thiscall, GJGarageLayer, showUnlockPopup, int, UnlockType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3880, Thiscall, GJGarageLayer, updateRate, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3570, Thiscall, GJGarageLayer, FLAlert_Clicked, FLAlertLayer*, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f36a0, Thiscall, GJGarageLayer, dialogClosed, DialogLayer*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1f3160, Thiscall, GJGarageLayer, playerColorChanged, )
		}
	};
}

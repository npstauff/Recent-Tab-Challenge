...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, TutorialLayer> : ModifyBase<ModifyDerive<Der, TutorialLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3be0a0, Optcall, TutorialLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3be140, Thiscall, TutorialLayer, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3bea00, Thiscall, TutorialLayer, keyBackClicked, )
		}
	};
}

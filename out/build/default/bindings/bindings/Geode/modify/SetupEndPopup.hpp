...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEndPopup> : ModifyBase<ModifyDerive<Der, SetupEndPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32c300, Optcall, SetupEndPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32c3b0, Membercall, SetupEndPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32cba0, Thiscall, SetupEndPopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x32cd90, Thiscall, SetupEndPopup, textChanged, CCTextInputNode*)
		}
	};
}

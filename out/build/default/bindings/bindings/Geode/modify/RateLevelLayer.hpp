...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, RateLevelLayer> : ModifyBase<ModifyDerive<Der, RateLevelLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f3fd0, Optcall, RateLevelLayer, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f4070, Membercall, RateLevelLayer, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2f4630, Thiscall, RateLevelLayer, keyBackClicked, )
		}
	};
}

...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJLevelList> : ModifyBase<ModifyDerive<Der, GJLevelList>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11bf40, Optcall, GJLevelList, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c470, Membercall, GJLevelList, addLevelToList, GJGameLevel*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11cdd0, Membercall, GJLevelList, completedLevels, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11d290, Membercall, GJLevelList, dataLoaded, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c420, Membercall, GJLevelList, duplicateListLevels, GJLevelList*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11d7e0, Membercall, GJLevelList, frameForListDifficulty, int, DifficultyIconType)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c7c0, Membercall, GJLevelList, getListLevelsArray, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c1b0, Membercall, GJLevelList, getUnpackedDescription, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c5c0, Membercall, GJLevelList, removeLevelFromList, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c6d0, Membercall, GJLevelList, reorderLevel, int, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11c770, Membercall, GJLevelList, reorderLevelStep, int, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11cef0, Membercall, GJLevelList, showListInfo, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11ccb0, Membercall, GJLevelList, updateLevelsString, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11d5c0, Thiscall, GJLevelList, encodeWithCoder, DS_Dictionary*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x11bfe0, Thiscall, GJLevelList, init, )
		}
	};
}

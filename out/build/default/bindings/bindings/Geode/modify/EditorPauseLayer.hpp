...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, EditorPauseLayer> : ModifyBase<ModifyDerive<Der, EditorPauseLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa2040, Membercall, EditorPauseLayer, onCreateLoop, cocos2d::CCObject*)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0xa3070, Thiscall, EditorPauseLayer, keyBackClicked, )

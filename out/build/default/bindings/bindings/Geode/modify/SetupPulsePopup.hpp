...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupPulsePopup> : ModifyBase<ModifyDerive<Der, SetupPulsePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x341420, Optcall, SetupPulsePopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3414d0, Membercall, SetupPulsePopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345450, Thiscall, SetupPulsePopup, show, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x344670, Thiscall, SetupPulsePopup, determineStartValues, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3451c0, Thiscall, SetupPulsePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3455f0, Thiscall, SetupPulsePopup, textChanged, CCTextInputNode*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x345360, Thiscall, SetupPulsePopup, colorValueChanged, cocos2d::ccColor3B)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x344db0, Thiscall, SetupPulsePopup, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}

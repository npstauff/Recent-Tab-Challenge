...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupMoveCommandPopup> : ModifyBase<ModifyDerive<Der, SetupMoveCommandPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fa630, Thiscall, SetupMoveCommandPopup, updateInputValue, int, float&)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fa5d0, Thiscall, SetupMoveCommandPopup, updateInputNode, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fa670, Thiscall, SetupMoveCommandPopup, valueDidChange, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fa410, Thiscall, SetupMoveCommandPopup, triggerValueFromSliderValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1fa4f0, Thiscall, SetupMoveCommandPopup, triggerSliderValueFromValue, int, float)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1faaa0, Thiscall, SetupMoveCommandPopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}

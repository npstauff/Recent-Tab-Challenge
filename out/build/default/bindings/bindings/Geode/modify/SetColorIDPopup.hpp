...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetColorIDPopup> : ModifyBase<ModifyDerive<Der, SetColorIDPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x210540, Optcall, SetColorIDPopup, create, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2105e0, Membercall, SetColorIDPopup, init, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2107c0, Thiscall, SetColorIDPopup, colorSelectClosed, GJSpecialColorSelect*, int)
		}
	};
}

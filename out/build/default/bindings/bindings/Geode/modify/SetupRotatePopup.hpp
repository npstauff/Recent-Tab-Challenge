...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupRotatePopup> : ModifyBase<ModifyDerive<Der, SetupRotatePopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34b030, Thiscall, SetupRotatePopup, onClose, cocos2d::CCObject*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x34b1b0, Thiscall, SetupRotatePopup, onCustomToggleTriggerValue, cocos2d::CCObject*)
		}
	};
}

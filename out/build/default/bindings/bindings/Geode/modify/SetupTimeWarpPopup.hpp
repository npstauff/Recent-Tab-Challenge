...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupTimeWarpPopup> : ModifyBase<ModifyDerive<Der, SetupTimeWarpPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x361c90, Optcall, SetupTimeWarpPopup, create, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x361d40, Membercall, SetupTimeWarpPopup, init, EffectGameObject*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x362120, Thiscall, SetupTimeWarpPopup, determineStartValues, )
		}
	};
}

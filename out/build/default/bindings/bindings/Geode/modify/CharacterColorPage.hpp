...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, CharacterColorPage> : ModifyBase<ModifyDerive<Der, CharacterColorPage>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x60120, Membercall, CharacterColorPage, colorForIndex, int)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x5f630, Membercall, CharacterColorPage, createColorMenu, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x605f0, Membercall, CharacterColorPage, offsetForIndex, int)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x608d0, Thiscall, CharacterColorPage, keyBackClicked, )
		}
	};
}

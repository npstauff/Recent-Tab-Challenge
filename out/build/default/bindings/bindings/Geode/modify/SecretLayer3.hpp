...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SecretLayer3> : ModifyBase<ModifyDerive<Der, SecretLayer3>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30a320, Thiscall, SecretLayer3, init, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30deb0, Thiscall, SecretLayer3, onExit, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30dea0, Thiscall, SecretLayer3, keyBackClicked, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x30dc10, Thiscall, SecretLayer3, dialogClosed, DialogLayer*)
		}
	};
}

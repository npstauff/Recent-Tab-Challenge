...
public:
    ...
    /**
     * @note[short] Windows: 0x11c5c0
     * @note[short] Android
     */
    TodoReturn removeLevelFromList(int p0);

    /**
     * @note[short] Windows: 0x11c6d0
     * @note[short] Android
     */
    TodoReturn reorderLevel(int p0, int p1);

    /**
     * @note[short] Windows: 0x11c770
     * @note[short] Android
     */
...
public:
    ...
    /**
     * @note[short] Windows: 0x11ccb0
     * @note[short] Android
     */
    TodoReturn updateLevelsString();

    /**
     * @note[short] Windows: 0x11d5c0
     * @note[short] Android
     */

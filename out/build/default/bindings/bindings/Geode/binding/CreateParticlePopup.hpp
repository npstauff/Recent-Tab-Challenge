...
public:
    ...
    /**
     * @note[short] Windows: 0x33cbb0
     * @note[short] Android
     */
    virtual void update(float p0);

    /**
     * @note[short] Windows: 0x33f6d0
     * @note[short] Android
     */
    virtual bool ccTouchBegan(cocos2d::CCTouch* p0, cocos2d::CCEvent* p1);

    /**
     * @note[short] Windows: 0x33f7b0
     * @note[short] Android
     */
    virtual void ccTouchMoved(cocos2d::CCTouch* p0, cocos2d::CCEvent* p1);

    /**
     * @note[short] Windows: 0x33fbd0
     * @note[short] Android
     */

...
public:
    ...
    /**
     * @note[short] Windows: 0x383f60
     * @note[short] Android
     */
    bool updateZLayer(int p0, int p1, bool p2);

    /**
     * @note[short] Windows: 0x37bde0
     * @note[short] Android
     */

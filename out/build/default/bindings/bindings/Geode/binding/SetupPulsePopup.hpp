...
public:
    ...
    /**
     * @note[short] Windows: 0x345450
     * @note[short] Android
     */
    virtual void show();

    /**
     * @note[short] Windows: 0x344670
     * @note[short] Android
     */
    virtual TodoReturn determineStartValues();

    /**
     * @note[short] Windows: 0x3451c0
     * @note[short] Android
     */
    virtual void onClose(cocos2d::CCObject* sender);

    /**
     * @note[short] Windows: 0x3455f0
     * @note[short] Android
     */
    virtual void textChanged(CCTextInputNode* p0);

    /**
     * @note[short] Windows: 0x345360
     * @note[short] Android
     */

...
public:
    ...
    /**
     * @note[short] Windows: 0x1a8530
     * @note[short] Android
     */
    TodoReturn maxZOrderForShaderZ(int p0);

    /**
     * @note[short] Windows: 0x1a84a0
     * @note[short] Android
     */

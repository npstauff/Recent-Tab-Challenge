...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, MusicSearchResult> : ModifyBase<ModifyDerive<Der, MusicSearchResult>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2898e0, Membercall, MusicSearchResult, updateObjects, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x2898d0, Thiscall, MusicSearchResult, stateChanged, OptionsObject*)
		}
	};
}

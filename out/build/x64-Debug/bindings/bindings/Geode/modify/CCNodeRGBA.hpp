...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, cocos2d::CCNodeRGBA> : ModifyBase<ModifyDerive<Der, cocos2d::CCNodeRGBA>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getNonVirtual(Resolve<>::func(&cocos2d::CCNodeRGBA::create)), Cdecl, cocos2d::CCNodeRGBA, create, )
			GEODE_APPLY_MODIFY_FOR_CONSTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??0CCNodeRGBA@cocos2d@@QAE@XZ")), Thiscall, cocos2d::CCNodeRGBA, )
			GEODE_APPLY_MODIFY_FOR_DESTRUCTOR(reinterpret_cast<uintptr_t>(GetProcAddress(GetModuleHandleA("libcocos2d.dll"), "??1CCNodeRGBA@cocos2d@@UAE@XZ")), Thiscall, cocos2d::CCNodeRGBA)
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<bool>::func(&cocos2d::CCNodeRGBA::setOpacityModifyRGB)), Thiscall, cocos2d::CCNodeRGBA, setOpacityModifyRGB, bool)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(addresser::getVirtual(Resolve<>::func(&cocos2d::CCNodeRGBA::isOpacityModifyRGB)), Thiscall, cocos2d::CCNodeRGBA, isOpacityModifyRGB, )

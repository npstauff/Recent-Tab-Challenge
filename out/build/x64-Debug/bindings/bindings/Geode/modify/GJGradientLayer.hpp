...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, GJGradientLayer> : ModifyBase<ModifyDerive<Der, GJGradientLayer>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ca710, Optcall, GJGradientLayer, create, )
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x1ca7b0, Thiscall, GJGradientLayer, init, )
		}
	};
}

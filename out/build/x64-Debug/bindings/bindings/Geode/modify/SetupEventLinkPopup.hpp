...
namespace geode::modifier {
	...
	struct ModifyDerive<Der, SetupEventLinkPopup> : ModifyBase<ModifyDerive<Der, SetupEventLinkPopup>> {
		...
		void apply() override {
			...
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x3647c0, Optcall, SetupEventLinkPopup, create, EventLinkTrigger*, cocos2d::CCArray*)
			GEODE_APPLY_MODIFY_FOR_FUNCTION(base::get() + 0x364870, Membercall, SetupEventLinkPopup, init, EventLinkTrigger*, cocos2d::CCArray*)
		}
	};
}

...
private:
     ...
     * @note[short] Android
     */
    static TodoReturn posForTime(float p0, cocos2d::CCArray* p1, int p2, bool p3, int& p4);
public:
     ...
     * @note[short] Android
     */
    static TodoReturn posForTimeInternal(float p0, cocos2d::CCArray* p1, int p2, bool p3, bool p4, bool p5, int& p6, int p7);
     ...
     * @note[short] Android
     */
    static TodoReturn timeForPos(cocos2d::CCPoint p0, cocos2d::CCArray* p1, int p2, int p3, int p4, bool p5, bool p6, bool p7, bool p8, int p9);
